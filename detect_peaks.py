...
def main():
    ...
    parser.add_argument("--yolo_weights", type=str, default='best_v0_2025-11-12.pt', help="YOLO weights filename (default: best_v0_2025-11-12.pt)")
    ...
    parser.add_argument("--include_molecules", action="store_true", default=False, help="Include molecular species in synthetic training data")
    parser.add_argument("--use_neighborhood", action="store_true", default=True, help="Use multi-peak neighborhood features for RF classification (default: True)")
    ...
    parser.add_argument("--use_signature", action="store_true", default=True, help="Use expert-mimicry signature features (isotopic/charge states) (default: True)")
